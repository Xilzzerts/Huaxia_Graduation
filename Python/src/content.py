...
class Content:
    ...
    def get_timetable(self):
        ...
        soup = BeautifulSoup(timetable_info_s, from_encoding='GB2312')
...
class XMLGenerator:
    def __init__(self, content):
        ...
        self.add_status()
        #if any error has occured , there must have no data
...
if __name__ == "__main__":
    ...
    print(x.mainnode.toprettyxml(encoding="UTF-8"))
